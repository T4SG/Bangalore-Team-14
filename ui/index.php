	...
	<body class="no-trans">
		...
		<div class="section clearfix object-non-visible" data-animation-effect="fadeIn">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1 id="about" class="title text-center">Registration</h1>
						<div class="space"></div>
						<div class="row">
							<!--<div class="col-md-6">
                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                               <body>
        <form method="post" action="./registrationprocess.php" id="frm" onSubmit="./registrationprocess.php"><a href="index.php">Home</a>
              <section>               
                <div id="container_demo" >
                    <!-- hidden anchor to stop jump http://www.css3create.com/Astuce-Empecher-le-scroll-avec-l-utilisation-de-target#wrap4  -->
                    <a class="hiddenanchor" id="toregister"></a>
                    ...
                    <div id="wrapper">
                      <!--   <div id="login" class="animate form">
                        ...
                        <div id="register" class="animate form">
                            <form  action="registrationprocess.php" autocomplete="on"> 
                                <h1> Sign up </h1> 
                                <p> 
                                    <label for="name" class="uname" data-icon="u">Your username</label>
                                    <input id="name" name="uname" required="required" type="text" placeholder="mysuperusername690" />
                                </p>
                                <p> 
                                ...
                                <p> 
                                 ...
                                 <p> 
                                    <label for="roleid">Select your role</label>
                                ...
                                <p> 
                                    <label for="qualifications" class="qualifications" data-icon="u" >Qualifications</label>
                                    <input id="qualifications" name="qualifications" required="qualifications" type="text"/>
                                </p>
                                <p> 
                                    <label for="locaton" class="place" data-icon="u" >place</label>
                                    <input id="location" name="location" required="qualifications" type="text"/>
                                </p>
                                 <p> 
                                    <label for="interests" class="Interests" data-icon="u" >Interests</label>
                                    <input id="interests" name="interests" required="interests" type="text"/>
                                </p>

                                <p> 
                                    <label for="language" class="language" data-icon="u" >language</label>
                                    <input id="language" name="language" required="Interests" type="text"/>
                                </p>                                <p> 
